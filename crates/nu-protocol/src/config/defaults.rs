...
pub fn default_color_config() -> HashMap<String, Value> {
    let entries: &[(&str, Value)] = &[
        ...
        ("shape_block", str("white")),
        ("shape_bool", str("#b58cc6")),
        ("shape_closure", str("white")),
        ("shape_custom", str("green")),
        ("shape_datetime", str("cyan")),
        ("shape_directory", str("cyan")),
        ("shape_external", str("purple")),
        ("shape_externalarg", str("blue")),
        ("shape_external_resolved", str("purple")),
        ("shape_filepath", str("cyan")),
        ("shape_flag", str("blue_bold")),
        ("shape_float", str("purple")),
        ("shape_glob_interpolation", str("blue")),
        ("shape_globpattern", str("blue")),
        ("shape_int", str("purple")),
        ("shape_internalcall", str("green")),
        ("shape_keyword", str("green")),
        ("shape_list", str("white")),
        ...
        ("shape_nothing", str("#b58cc6")),
        ("shape_operator", str("#e49641")),
        ("shape_pipe", str("#e49641")),
        ("shape_range", str("yellow_bold")),
        ("shape_record", str("cyan_bold")),
        ("shape_redirection", str("purple_bold")),
        ("shape_signature", str("green")),
        ("shape_string", str("yellow")),
        ("shape_string_interpolation", str("cyan_bold")),
        ("shape_table", str("white")),
        ("shape_variable", str("#e49641")),
        ("shape_vardecl", str("purple")),
        ("shape_raw_string", str("light_magenta_bold")),
        (
            "shape_garbage",
            rec(record! {
                "fg" => str("#1f1f1f"),
